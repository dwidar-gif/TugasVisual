...
public class login extends javax.swing.JFrame {
 private final Connection conn = new koneksi().connect();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Aplikasi Pengolahan Data Warga");
        ...
        txtpass.setFont(new java.awt.Font("Tempus Sans ITC", 1, 18)); // NOI18N
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 610, 240));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          if(txtuser.getText().equals("admin")&& txtpass.getText().equals("0402"))
